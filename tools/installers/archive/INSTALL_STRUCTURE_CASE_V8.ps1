...
Write-Host "=== INSTALL STRUCTURE CASE V8 ===" -ForegroundColor Cyan
...
$backup=Join-Path $env:LOCALAPPDATA "BTCUSDT_Price_Action_Lab_structure_case_v8_backup_$stamp"
New-Item -ItemType Directory -Path $backup -Force|Out-Null

$files=@(
  "index.html","src\main.js","src\style.css","src\case_entry_research.js",
  "src\structure_case_lab.js","tests\structure_case_v8_smoke.mjs"
)
...
Write-Host "[1/3] Installing validated V8 files..." -ForegroundColor Cyan
...
Copy-Item (Join-Path $PatchRoot "payload\tests\structure_case_v8_smoke.mjs") (Join-Path $LabRoot "tests\structure_case_v8_smoke.mjs") -Force

Write-Host "[2/3] Commit code..." -ForegroundColor Cyan
git add index.html src/main.js src/style.css src/case_entry_research.js src/structure_case_lab.js tests/structure_case_v8_smoke.mjs
$changes=git status --porcelain
if($changes){
  git commit -m "Use global chart dates and ideal entry zones"
...
Write-Host ""
Write-Host "STRUCTURE CASE V8 PUSH COMPLETE" -ForegroundColor Green
